...
DRIVER_IMAGES = {
    ...
    "russell": get_img("imagesf1/russell.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/G/GEORUS01_George_Russell/georus01.png"),
    "antonelli": get_img("imagesf1/antonelli.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/A/ANDANT01_Andrea_Kimi_Antonelli/andant01.png"),
    "sainz": get_img("imagesf1/sainz.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/C/CARSAI01_Carlos_Sainz/carsai01.png"),
    "albon": get_img("imagesf1/albon.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/A/ALXALB01_Alexander_Albon/alxalb01.png"),
    "alonso": get_img("imagesf1/alonso.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/F/FERALO01_Fernando_Alonso/feralo01.png"),
    "stroll": get_img("imagesf1/stroll.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/L/LANSTR01_Lance_Stroll/lanstr01.png"),
    "gasly": get_img("imagesf1/gastly.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/P/PIEGAS01_Pierre_Gasly/piegas01.png"),
    "colapinto": get_img("imagesf1/colapinto.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/F/FRACOL01_Franco_Colapinto/fracol01.png"),
    "hulkenberg": get_img("imagesf1/hulkenberg.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/N/NICHUL01_Nico_Hulkenberg/nichul01.png"),
    "bortoleto": get_img("imagesf1/bortoleto.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/G/GABBOR01_Gabriel_Bortoleto/gabbor01.png"),
    "ocon": get_img("imagesf1/ocon.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/E/ESTOCO01_Esteban_Ocon/estoco01.png"),
    "bearman": get_img("imagesf1/bearman.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/O/OLIBEA01_Oliver_Bearman/olibea01.png"),
    "lawson": get_img("imagesf1/lawson.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/L/LIALAW01_Liam_Lawson/lialaw01.png"),
    "lindblad": get_img("imagesf1/lindblad.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/A/ARVLIN01_Arvid_Lindblad/arvlin01.png"),
    "perez": get_img("imagesf1/perez.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/S/SERPER01_Sergio_Perez/serper01.png"),
    "bottas": get_img("imagesf1/bottas.jpg", "https://media.formula1.com/d_driver_fallback_image.png/content/dam/fom-website/drivers/V/VALBOT01_Valtteri_Bottas/valbot01.png"),
}
...
TEAM_LOGOS = {
    "mclaren": get_img("imagesf1/mclaren.jpg", "https://upload.wikimedia.org/wikipedia/en/thumb/6/66/McLaren_Racing_logo.svg/512px-McLaren_Racing_logo.svg.png"),
    "red_bull": get_img("imagesf1/red_bull.jpg", "https://upload.wikimedia.org/wikipedia/en/thumb/1/15/Red_Bull_Racing_logo.svg/512px-Red_Bull_Racing_logo.svg.png"),
    "ferrari": get_img("imagesf1/ferrari.jpg", "https://upload.wikimedia.org/wikipedia/en/thumb/d/d1/Ferrari-Logo.svg/512px-Ferrari-Logo.svg.png"),
    "mercedes": get_img("imagesf1/mercedes.jpg", "https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Mercedes-Benz_in_Formula_One_logo.svg/512px-Mercedes-Benz_in_Formula_One_logo.svg.png"),
    "aston_martin": get_img("imagesf1/aston_martin.jpg", "https://upload.wikimedia.org/wikipedia/en/thumb/b/bd/Aston_Martin_F1_team_logo.svg/512px-Aston_Martin_F1_team_logo.svg.png"),
    "williams": get_img("imagesf1/williams.jpg", "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Williams_F1_logo.svg/512px-Williams_F1_logo.svg.png"),
    "alpine": get_img("imagesf1/alpine.jpg", "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Alpine_F1_Team_Logo.svg/512px-Alpine_F1_Team_Logo.svg.png"),
    "audi": get_img("imagesf1/audi.jpg", "https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/Audi_logo_detail.svg/512px-Audi_logo_detail.svg.png"),
    "haas": get_img("imagesf1/haas.jpg", "https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Haas_F1_Team_logo.svg/512px-Haas_F1_Team_logo.svg.png"),
    "racing_bulls": get_img("imagesf1/racing_bulls.jpg", "https://upload.wikimedia.org/wikipedia/en/thumb/2/2b/VCARB_F1_logo.svg/512px-VCARB_F1_logo.svg.png"),
    "cadillac": get_img("imagesf1/cadillac.jpg", "https://upload.wikimedia.org/wikipedia/en/thumb/3/33/Cadillac_logo.svg/512px-Cadillac_logo.svg.png")
}
